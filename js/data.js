...
const VALVES = [
      ...
      { id: 'threeway',  label: '三通閥', symbol: '<circle cx="60" cy="26" r="16" fill="#ffca28" stroke="#f9a825" stroke-width="3"/><line x1="60" y1="2" x2="60" y2="10" stroke="#f9a825" stroke-width="3"/><line x1="12" y1="26" x2="44" y2="26" stroke="#f9a825" stroke-width="3"/><line x1="76" y1="26" x2="108" y2="26" stroke="#f9a825" stroke-width="3"/>' },
      { id: 'fourway',   label: '四通閥', symbol: '<circle cx="60" cy="26" r="16" fill="#ffca28" stroke="#f9a825" stroke-width="3"/><line x1="60" y1="2" x2="60" y2="10" stroke="#f9a825" stroke-width="3"/><line x1="60" y1="42" x2="60" y2="50" stroke="#f9a825" stroke-width="3"/><line x1="12" y1="26" x2="44" y2="26" stroke="#f9a825" stroke-width="3"/><line x1="76" y1="26" x2="108" y2="26" stroke="#f9a825" stroke-width="3"/>' },
    ...
    VALVES.concat(EQUIPMENT).concat(ROCKET).concat(DAQ).forEach(function (v) {
      NODE_TYPES[v.id] = { label: v.label, cls: 'sym', in: 1, out: 1, symbol: v.symbol };
    });
    const CATEGORIES = [
